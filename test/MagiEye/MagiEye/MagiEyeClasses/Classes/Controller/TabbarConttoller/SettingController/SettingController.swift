...
extension SettingController: UITableViewDataSource, UITableViewDelegate {
    ...
    func tableView(_ tableView: UITableView, willDisplay cell: UITableViewCell, forRowAt indexPath: IndexPath) {
        ...
        if indexPath.row == 0 {
            ...
            accessoryView.isOn = EyesManager.shared.isMagiLogEyeOpening()
            ...
            accessoryView.isOn = EyesManager.shared.isCatonEyeOpening()
    ...
    @objc private func switchValueChanged(sender:UISwitch) {
        ...
        if index == 0 {
            ...
            let manager = EyesManager.shared
            sender.isOn == true ? manager.openMagiLogEye() : manager.closeMagiLogEye()
        }else if index == 2 {
            let manager = EyesManager.shared
            ...
            let manager = EyesManager.shared
            sender.isOn == true ? manager.openCatonEye() : manager.closeCatonEye()
        }else if index == 5 {
            let manager = EyesManager.shared
