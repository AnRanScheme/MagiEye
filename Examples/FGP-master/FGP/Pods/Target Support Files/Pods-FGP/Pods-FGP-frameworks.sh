...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/MagiPhotoBrowser/MagiPhotoBrowser.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/MagiRefresh/MagiRefresh.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/QuickCocoa/QuickCocoa.framework"
