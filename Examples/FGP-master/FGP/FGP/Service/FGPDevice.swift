...
class FGPDevice: NSObject {
    ...
    static var iPhone6: Bool {
        return UIScreen.main.bounds.size.equalTo(CGSize(width: 375, height: 667))
    }
    
    static var iPhone6Plus: Bool {
        return UIScreen.main.bounds.size.equalTo(CGSize(width: 414, height: 736))
    }
